  ...
  <div class="mx-auto max-w-4xl">
    ...
    <ul v-else class="grid gap-4 sm:grid-cols-2">
      <li v-for="ev in events" :key="ev.id">
        ...
        >
          <span
            class="inline-block rounded-full px-2.5 py-0.5 text-[10px] uppercase tracking-wider" :class="[
              ev.status === 'active'
          ...
          <h2 class="mt-3 font-display text-xl text-(--color-foreground)">
            {{ ev.couple_names }}
          </h2>
