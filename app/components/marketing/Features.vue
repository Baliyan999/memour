...
<template>
  ...
  >
    ...
    <div class="container-page relative">
      ...
      <ul class="mx-auto mt-6 flex max-w-6xl snap-x snap-mandatory gap-4 overflow-x-auto px-6 pb-6 -mx-6 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:m-0 sm:grid sm:auto-rows-[240px] sm:grid-cols-2 sm:gap-5 sm:overflow-visible sm:p-0 lg:auto-rows-[220px] lg:grid-cols-3 lg:gap-6 xl:max-w-[80rem] xl:auto-rows-[230px] 2xl:max-w-[92rem] 2xl:auto-rows-[250px] 2xl:gap-7 3xl:max-w-[108rem] 3xl:auto-rows-[280px] 3xl:gap-8 4xl:max-w-[128rem] 4xl:auto-rows-[330px] 4xl:gap-10">
        <motion.li
          v-for="card in cards"
          :key="card.key"
          ...
          :class="[
            'group relative isolate flex h-[460px] w-[82%] shrink-0 snap-center flex-col overflow-hidden rounded-(--radius-xl) border border-(--color-border)/60 bg-white/80 backdrop-blur-sm transition-[border-color] duration-500 hover:border-(--color-primary)/40 sm:h-auto sm:w-auto sm:shrink',
            card.span,
          ]"
        ...
        >
          ...
          <div class="relative h-[260px] shrink-0 overflow-hidden sm:h-auto sm:flex-1 sm:min-h-[55%]">
