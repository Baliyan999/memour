...
function renderVisual(variant: Visual) {
  ...
  if (variant === 'fan') {
    const cards = [
      { hue: 15, rot: -18, x: -2.2, z: 1, src: '/images/confetti.webp', size: 'h-32 w-24 sm:h-44 sm:w-32 md:h-56 md:w-40 lg:h-60 lg:w-44 xl:h-64 xl:w-48 2xl:h-72 2xl:w-52 3xl:h-80 3xl:w-60 4xl:h-96 4xl:w-72', intensity: 0.08 },
      { hue: 40, rot: -9, x: -1.05, z: 2, src: '/images/fairy-lights.webp', size: 'h-36 w-28 sm:h-48 sm:w-36 md:h-60 md:w-44 lg:h-64 lg:w-48 xl:h-72 xl:w-52 2xl:h-80 2xl:w-56 3xl:h-[22rem] 3xl:w-64 4xl:h-[26rem] 4xl:w-80', intensity: 0.08 },
      { hue: 60, rot: 0, x: 0, z: 3, src: '/images/hand-holding.webp', size: 'h-40 w-32 sm:h-52 sm:w-40 md:h-64 md:w-48 lg:h-72 lg:w-52 xl:h-80 xl:w-60 2xl:h-[22rem] 2xl:w-64 3xl:h-[26rem] 3xl:w-72 4xl:h-[30rem] 4xl:w-[22rem]', intensity: 0.1 },
      { hue: 80, rot: 9, x: 1.05, z: 2, src: '/images/lace-texture.webp', size: 'h-36 w-28 sm:h-48 sm:w-36 md:h-60 md:w-44 lg:h-64 lg:w-48 xl:h-72 xl:w-52 2xl:h-80 2xl:w-56 3xl:h-[22rem] 3xl:w-64 4xl:h-[26rem] 4xl:w-80', intensity: 0.08 },
      { hue: 100, rot: 18, x: 2.2, z: 1, src: '/images/ribbons.webp', size: 'h-32 w-24 sm:h-44 sm:w-32 md:h-56 md:w-40 lg:h-60 lg:w-44 xl:h-64 xl:w-48 2xl:h-72 2xl:w-52 3xl:h-80 3xl:w-60 4xl:h-96 4xl:w-72', intensity: 0.08 },
    ]
    return h(
      'div',
      ...
      cards.map((c, i) =>
        h(
          ...
          h(PhotoCard, { hue: c.hue, rotate: c.rot, cls: c.size, intensity: c.intensity, src: c.src }),
        ),
      ),
    )
  }
  // grid
  const GRID_PHOTOS = [
    '/images/vintage-camera.webp',
    '/images/feet-dancing.webp',
    '/images/aesthetic-closeup.webp',
    '/images/cutting-cake.webp',
    '/images/waiter.webp',
    '/images/bokeh.webp',
    '/images/rings.webp',
